...
import { Users, BookOpen, CheckCircle2, Phone, UserCircle } from 'lucide-react'
import { facilities } from '../data/takmir'
...
export default function Tentang() {
    const { pengurus, profile, isLoading } = useData()
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-white/70 max-w-xl">
                            Mengenal lebih dekat {profile?.name || 'Masjid Raudhatul Jannah'} — sejarah, struktur organisasi, dan fasilitas yang tersedia.
                        </p>
                    </motion.div>
                </div>
            </section>
                ...
                >
                    ...
                    <div className="prose prose-gray max-w-none">
                        <p className="text-gray-600 leading-relaxed mb-4">
                            {profile?.name || 'Masjid Raudhatul Jannah'} didirikan pada tahun 2010 oleh para warga pendiri perumahan Griya Tamansari 2.
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
                ...
                >
                    {pengurus.map((member) => (
                        ...
                        >
                            {/* Avatar */}
                            <div className="w-14 h-14 bg-gradient-to-br from-primary to-primary-light rounded-xl flex items-center justify-center mb-4 shadow-md shadow-primary/20 overflow-hidden">
                                {member.photo ? (
